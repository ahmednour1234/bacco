...
@section('title', __('app.dashboard') . ' – ' . __('app.supplier_portal_title'))
...
<div class="space-y-6">
    ...
    <div class="rounded-2xl bg-emerald-600 px-6 py-5 text-white shadow-lg shadow-emerald-500/20">
        <p class="text-sm font-medium text-emerald-200">{{ __('app.welcome_back') }}</p>
        <h2 class="text-2xl font-bold mt-0.5">{{ auth()->user()->name }}</h2>
        <p class="text-emerald-200 text-sm mt-1">{{ __('app.manage_catalogue_msg') }}</p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-wide text-slate-400">{{ __('app.total_products') }}</p>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-wide text-slate-400">{{ __('app.active') }}</p>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-wide text-slate-400">{{ __('app.inactive') }}</p>
