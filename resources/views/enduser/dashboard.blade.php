        ...
        <div class="relative overflow-hidden rounded-2xl bg-white shadow-sm transition hover:shadow-md hover:-translate-y-0.5"
            ...
            <div class="flex items-center justify-between px-4 pt-4 pb-3">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-2xl font-black leading-none text-slate-900">{{ $projectStats['total'] }}</p>
                </div>
        ...
        <div class="relative overflow-hidden rounded-2xl bg-white shadow-sm transition hover:shadow-md hover:-translate-y-0.5"
            ...
            <div class="flex items-center justify-between px-4 pt-4 pb-3">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-2xl font-black leading-none text-slate-900">{{ $projectStats['active'] }}</p>
                </div>
                <svg class="h-10 w-16 flex-shrink-0 opacity-50" viewBox="0 0 64 40" fill="none">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-white shadow-sm transition hover:shadow-md hover:-translate-y-0.5"
            ...
            <div class="flex items-center justify-between px-4 pt-4 pb-3">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-2xl font-black leading-none text-slate-900">{{ $projectStats['completed'] }}</p>
                </div>
                <svg class="h-10 w-16 flex-shrink-0 opacity-50" viewBox="0 0 64 40" fill="none">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-white shadow-sm transition hover:shadow-md hover:-translate-y-0.5"
            ...
            <div class="flex items-center justify-between px-4 pt-4 pb-3">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-2xl font-black leading-none text-slate-900">{{ $projectStats['pending'] }}</p>
                </div>
                <svg class="h-10 w-16 flex-shrink-0 opacity-50" viewBox="0 0 64 40" fill="none">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-white shadow-sm transition hover:shadow-md hover:-translate-y-0.5"
            ...
            <div class="flex items-center justify-between px-4 pt-4 pb-3">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-2xl font-black leading-none text-slate-900">{{ $projectStats['cancelled'] }}</p>
                </div>
                <svg class="h-10 w-16 flex-shrink-0 opacity-50" viewBox="0 0 64 40" fill="none">
