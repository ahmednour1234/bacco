...
<div class="px-6 py-8 max-w-7xl mx-auto">
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">{{ __('app.articles') }}</h1>
            <p class="mt-0.5 text-sm text-slate-500">{{ __('app.manage_articles_desc') }}</p>
        </div>
