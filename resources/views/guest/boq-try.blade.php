...
.try-badge {
    ...
    padding: 7px 22px;
    margin-bottom: 32px;
    box-shadow: 0 2px 14px #10b98118;
...
<div class="try-steps-wrap" @if($isAr) dir="rtl" @endif>
    <div class="try-steps">
        @if($isAr)
            ...
            <div class="try-step-arrow" style="transform:scaleX(-1)">→</div>
            <div class="try-step">
        ...
        @else
            <div class="try-step">
                ...
                <div>
                    <div class="try-step-label">Upload BOQ file</div>
                    <div class="try-step-sublabel">Excel, PDF or image</div>
                </div>
            </div>
            ...
            <div class="try-step">
                ...
                <div>
                    <div class="try-step-label">AI extracts items</div>
                    <div class="try-step-sublabel">Automatic, zero effort</div>
                </div>
            </div>
            <div class="try-step-arrow">→</div>
            <div class="try-step">
                ...
                <div>
                    <div class="try-step-label">Live market pricing</div>
                    <div class="try-step-sublabel">Real, up-to-date prices</div>
                </div>
            </div>
            <div class="try-step-arrow">→</div>
            <div class="try-step">
                ...
                <div>
                    <div class="try-step-label">Sign in & download PDF</div>
                    <div class="try-step-sublabel">Save & share your quote</div>
                </div>
            </div>
        @endif
    </div>
