...
<head>
    ...
    <link rel="preload" href="/public/fonts/cairo/cairo-arabic.woff2" as="font" type="font/woff2" crossorigin>
    <link rel="preload" href="/public/fonts/cairo/cairo-latin.woff2" as="font" type="font/woff2" crossorigin>
    <style>
        ...
        @font-face {
            ...
            font-weight: 100 900;
            font-display: swap;
            src: url('/public/fonts/cairo/cairo-arabic.woff2') format('woff2');
        ...
        @font-face {
            ...
            font-weight: 100 900;
            font-display: swap;
            src: url('/public/fonts/cairo/cairo-latin-ext.woff2') format('woff2');
        ...
        @font-face {
            ...
            font-weight: 100 900;
            font-display: swap;
            src: url('/public/fonts/cairo/cairo-latin.woff2') format('woff2');
        ...
        * { font-family: 'Cairo', sans-serif; }
        body { font-family: 'Cairo', sans-serif; background: var(--white); color: var(--dark); font-size: 15px; line-height: 1.65; overflow-x: hidden; }
        ...
        /* ── NAV ── */
        .nav { position: sticky; top: 0; z-index: 100; background: rgba(255,255,255,0.97); backdrop-filter: blur(18px); -webkit-backdrop-filter: blur(18px); border-bottom: 1px solid rgba(0,106,59,0.10); box-shadow: 0 2px 16px rgba(0,0,0,0.06), 0 1px 0 rgba(0,106,59,0.07); }
        ...
        .mobile-menu { display: none; position: fixed; top: 96px; left: 0; right: 0; bottom: 0; background: var(--white); z-index: 99; padding: 20px 24px; padding-bottom: calc(20px + env(safe-area-inset-bottom)); flex-direction: column; gap: 0; overflow-y: auto; border-top: 1px solid rgba(0,106,59,0.10); }
        ...
        /* ── FOOTER ── */
        .footer { background: #fafaf8; padding: 72px 0 36px; border-top: 1px solid rgba(0,106,59,0.10); }
        .footer-top { display: grid; grid-template-columns: 1.6fr 1fr 1fr 1fr; gap: 48px; margin-bottom: 56px; }
        .footer-logo { margin-bottom: 14px; }
        .footer-logo img, .footer-logo svg { height: 40px; width: auto; display: block; }
        .footer-tagline { font-size: 13.5px; color: #555; line-height: 1.7; max-width: 250px; margin-bottom: 22px; }
        ...
        .footer-bottom { border-top: 1px solid rgba(0,106,59,0.10); padding-top: 28px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 12px; }
        ...
        @media (max-width: 768px) {
            ...
            .footer-logo img, .footer-logo svg { height: 34px; }
        }
            ...
            <div class="footer-top">
                <div>
                    ...
                    <div class="footer-socials">
                        ...
                        <a href="https://x.com/QimtaSm" target="_blank" rel="noopener" class="social-btn" title="X" aria-label="Qimta on X (Twitter)"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L2.12 2.25h6.977l4.253 5.622 5.894-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg></a>
                        <a href="https://www.linkedin.com/company/qimta/about/?viewAsMember=true" target="_blank" rel="noopener" class="social-btn" title="LinkedIn" aria-label="Qimta on LinkedIn"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg></a>
                    </div>
                </div>
