...
>
    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">All Quotations</h1>
            <p class="mt-1 text-sm text-slate-500">
                Track every client quotation and its current status.
                Total: <span class="font-semibold text-slate-700">{{ $total }} records</span>
            </p>
        </div>
    </div>
    ...
    <div class="mb-5 flex flex-wrap items-center gap-3">
        ...
        <div class="relative flex-1 min-w-[260px]">
            ...
            <input
                ...
                placeholder="Search by Quotation ID, Company, Client, or Project..."
        ...
        <div class="relative">
            ...
            >
                <p class="mb-2 text-xs font-semibold uppercase tracking-wide text-slate-400">Filter by Company</p>
                <input
                    type="search"
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b border-slate-100 bg-slate-50 text-left">
                            <th class="px-5 py-3.5 text-xs font-semibold uppercase tracking-wide text-slate-400 w-28">ID</th>
                            <th class="px-5 py-3.5 text-xs font-semibold uppercase tracking-wide text-slate-400">Company</th>
                            <th class="px-5 py-3.5 text-xs font-semibold uppercase tracking-wide text-slate-400">Client</th>
                            <th class="px-5 py-3.5 text-xs font-semibold uppercase tracking-wide text-slate-400">Project</th>
                            <th class="px-5 py-3.5 text-xs font-semibold uppercase tracking-wide text-slate-400 w-32">Created</th>
                            <th class="px-5 py-3.5 text-xs font-semibold uppercase tracking-wide text-slate-400 w-36 text-right">
                                Amount<br><span class="normal-case">(SAR)</span>
                            </th>
                            <th class="px-5 py-3.5 text-xs font-semibold uppercase tracking-wide text-slate-400 w-36">Status</th>
                            <th class="px-5 py-3.5 text-xs font-semibold uppercase tracking-wide text-slate-400 w-24 text-center">Actions</th>
                        </tr>
                    </thead>
