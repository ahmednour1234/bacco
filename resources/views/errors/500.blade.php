...
<head>
    ...
    <title>500 — Server Error | QIMTA</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Server error card illustration ── */
        .err-card {
            position: absolute;
            z-index: 1;
            background: #fff;
...
<body>
    ...
    <h1 class="err-h1">Server error</h1>
    <span class="err-ar">عذراً، حدث خطأ في الخادم</span>

    <p class="err-sub">
        Our pricing engine encountered an unexpected error. Our team has been notified and is working on a fix. Please try again shortly.
    </p>

    <div class="err-btns">
        <a href="{{ url('/') }}" class="btn-green">Go to Homepage</a>
        <a href="{{ url()->previous() !== url()->current() ? url()->previous() : '/' }}" class="btn-green-outline">Try Again</a>
    </div>
