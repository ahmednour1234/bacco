    ...
    public function run(): void
    {
        ...
        $articles = [
            ...
            [
                ...
                'title_ar' => 'كيفية الطلب عبر كيمتا بعد تسعير جدول الكميات',
                'image'    => $images[0],
                'active'   => true,
                ...
                'desc_ar'  => '<h2>مقدمة</h2><p>الانتقال من جدول الكميات المسعَّر إلى أمر شراء نهائي هو نقطة تحوّل حاسمة في عملية الشراء. توحّد منصة كيمتا هذا الانتقال لضمان سلامة البيانات وحماية الأسعار.</p><h2>الخطوة 1: التسجيل وتأمين مساحة العمل</h2><p>قبل الشروع في الدفع، تأكد من اكتمال التحقق من حساب المؤسسة لقفل إعدادات الامتثال الضريبي وصلاحيات الشراء.</p><h2>الخطوة 2: فتح البنود المسعَّرة ومراجعتها</h2><p>ادخل إلى "التقديرات المحفوظة" وتحقق من تحذيرات انتهاء صلاحية الأسعار.</p><h2>الخطوة 3: مقارنة خيارات الموردين</h2><p>تعرض كيمتا مصفوفة من التجار لكل وحدة. بدّل بين <strong>الأقل تكلفة</strong> أو <strong>الأسرع توصيلاً</strong>.</p>',
            ],
            // 2
            [
            ...
            [
                ...
                'desc_ar'  => '<h2>نظرة عامة</h2><p>تعمل المشاريع العملاقة السعودية — نيوم والخط وبوابة الدرعية وغيرها — وفق إطار صارم للتأهيل المسبق للموردين. تشرح هذه المقالة كيف تبسّط كيمتا الامتثال لفرق المشتريات.</p><h2>الشهادات المطلوبة</h2><ul><li>نظام إدارة الجودة ISO 9001:2015</li><li>شهادة منتج هيئة المواصفات والمقاييس والجودة السعودية</li><li>امتثال الفوترة الإلكترونية لهيئة الزكاة والضريبة والجمارك</li></ul><h2>محرك التحقق الآلي من كيمتا</h2><p>تتصل كيمتا ببوابة الهيئة وواجهات برمجة هيئة الزكاة في الوقت الفعلي للتحقق من شهادات الموردين قبل السماح لهم بتقديم العروض.</p>',
            ],
            // 5
            [
                'name_en'  => 'Technology',
            ...
            [
                ...
                'desc_ar'  => '<h2>أهمية المشتريات الخضراء</h2><p>تُسهم صناعة البناء بنحو 39% من انبعاثات الكربون العالمية. قرارات المشتريات هي أحد أعلى النقاط تأثيراً لتقليل الكربون المتضمَّن في الأصول المبنية.</p><h2>فئات المواد الخضراء الرئيسية</h2><ul><li><strong>الخرسانة المنخفضة الكربون</strong></li><li><strong>الفولاذ المُعاد تدويره</strong></li><li><strong>الأخشاب المعتمدة</strong></li></ul><h2>مرشحات الاستدامة في كيمتا</h2><p>يتضمن كتالوج كيمتا مرشح إعلانات المنتجات البيئية للتحقق من بيانات الكربون.</p>',
            ],
            // 7
            [
                'name_en'  => 'Finance',
            ...
            [
                ...
                'desc_ar'  => '<h2>تكلفة نفاد المخزون في مواقع البناء</h2><p>يمكن لحدث نفاد مخزون واحد أن يوقف جبهة عمل كاملة. مع متوسط تكاليف العمالة اليومية البالغة 85,000 ريال للمشاريع متوسطة الحجم.</p><h2>بنية المخزون الفوري في كيمتا</h2><p>تحتفظ كيمتا ببيانات المخزون الحية من أكثر من 340 موردًا معتمدًا في السعودية، تُحدَّث كل 15 دقيقة.</p>',
            ],
            // 9
            [
                'name_en'  => 'Guides',
                ...
                'title_ar' => 'إعداد أول مشروع لك على كيمتا: دليل خطوة بخطوة',
                'image'    => $images[8],
                'active'   => true,
                ...
                'desc_ar'  => '<h2>قبل البدء</h2><p>لإنشاء مشروع على كيمتا، ستحتاج إلى حساب مؤسسي نشط وموقع مُتحقَّق منه وجدول المشروع الرئيسي.</p><h2>الخطوة 1: إنشاء سجل المشروع</h2><p>انتقل إلى المشاريع ← مشروع جديد. أدخل اسم المشروع والعميل والإحداثيات الجغرافية وتواريخ البدء والانتهاء المتوقعة.</p><h2>الخطوة 2: رفع الجدول الرئيسي</h2><p>استورد ملف MS Project أو Primavera P6. تقوم كيمتا بتحليل الجدول وإنشاء معالم المشتريات.</p>',
            ],
            // 10
            [
                'name_en'  => 'Market Analysis',
