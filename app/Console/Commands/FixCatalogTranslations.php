...
class FixCatalogTranslations extends Command
{
    ...
    private function glossary(): array
    {
        $pairs = [
            ...
            // ── Fire alarm / detection (batch 3) ────────────────────────────
            'Alarm Repeater Unit'                     => 'وحدة تكرار الإنذار',
            'Aspiration Smoke Detection System'       => 'نظام كشف الدخان بالشفط',
            'Beam Smoke Detector'                     => 'كاشف الدخان الشعاعي',
            'Control Module'                          => 'وحدة تحكم',
            'Control Panel'                           => 'لوحة تحكم',
            'Flame Detector'                          => 'كاشف اللهب',
            'Gas Detector'                            => 'كاشف الغاز',
            'Heat Detector'                           => 'كاشف الحرارة',
            'Manual Call Point'                       => 'نقطة إنذار يدوية',
            'Monitor Module'                          => 'وحدة مراقبة',
            'Remote Indicator'                        => 'مؤشر عن بُعد',
            'Repeater Panel'                          => 'لوحة تكرار',
            'Short Circuit Isolator'                  => 'عازل الدائرة القصيرة',
            'Smoke Detector'                          => 'كاشف الدخان',
            'Sounder with Flasher'                    => 'جرس إنذار مع وامض',
            'Sounder with Strobe'                     => 'جرس إنذار مع فلاش',
            'Telephone Jack'                          => 'مقبس الهاتف',
            'Voice Evacuation Control System'         => 'نظام التحكم في الإخلاء الصوتي',
            'Voice Evacuation Speaker'                => 'سماعة الإخلاء الصوتي',

            // ── Fit-out / facilities (batch 3) ──────────────────────────────
            'Data Center Fitout'                      => 'تجهيزات مراكز البيانات',
            'Exhibition / Convention / Fit-Out Base Materials' => 'مواد تجهيز المعارض والمؤتمرات',
            'Exhibition & Convention Fitout'          => 'تجهيزات المعارض والمؤتمرات',
            'Facade Access & Maintenance Systems'     => 'أنظمة الوصول وصيانة الواجهات',
            'Flagpoles & Exterior Specialties'        => 'السواري والتجهيزات الخارجية المتخصصة',
            'Food Service Equipment'                  => 'معدات خدمات الطعام',
            'Hajj & Umrah Facility'                   => 'مرافق الحج والعمرة',
            'Healthcare Facility Fitout'              => 'تجهيزات المرافق الصحية',
            'Hospitality Fitout'                      => 'تجهيزات الضيافة',
            'Industrial Process Equipment'            => 'معدات العمليات الصناعية',
            'Kitchen Equipment'                       => 'معدات المطابخ',
            'Laboratory Fitout'                       => 'تجهيزات المختبرات',
            'Laundry Equipment'                       => 'معدات الغسيل',
            'Loading Dock Equipment'                  => 'معدات أرصفة التحميل',
            'Military / Sensitive Buildings Envelope' => 'أغلفة المباني العسكرية والحساسة',
            'Military & Security Fitout'              => 'التجهيزات العسكرية والأمنية',
            'Mosque & Religious Facility'             => 'المساجد والمرافق الدينية',
            'Prison & Detention Facility'             => 'مرافق السجون والاحتجاز',
            'Residential Equipment'                   => 'المعدات السكنية',
            'Stadium & Sports Facility'               => 'الملاعب والمرافق الرياضية',
            'Swimming Pool & Aquatic Facility'        => 'المسابح والمرافق المائية',

            // ── Water / waste / environment (batch 3) ───────────────────────
            'Desalination'                            => 'تحلية المياه',
            'Hazardous Waste'                         => 'النفايات الخطرة',
            'Medical Waste Treatment'                 => 'معالجة النفايات الطبية',
            'Noise & Vibration Control'               => 'التحكم في الضوضاء والاهتزاز',
            'Pumping Stations'                        => 'محطات الضخ',
            'Radiation Shielding'                     => 'الحماية من الإشعاع',
            'Sludge Treatment'                        => 'معالجة الحمأة',
            'Solid Waste Management'                  => 'إدارة النفايات الصلبة',
            'Sound & Vibration Control'               => 'التحكم في الصوت والاهتزاز',
            'Treated Sewage Effluent Reuse'           => 'إعادة استخدام مياه الصرف المعالجة',
            'Wastewater Treatment'                    => 'معالجة مياه الصرف',
            'Water Treatment'                         => 'معالجة المياه',

            // ── Transport / operations (batch 3) ────────────────────────────
            'Intelligent Transportation Systems'      => 'أنظمة النقل الذكية',
            'Parking Systems'                         => 'أنظمة مواقف السيارات',
            'Port & Maritime Operations'              => 'العمليات المينائية والبحرية',
            'Rail & Metro Operations'                 => 'عمليات السكك والمترو',
            'Traffic Management'                      => 'إدارة المرور',
